...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8aa1cceb3e2d5b45b614600ec07b0d86) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ccss", []))];
            ...
            [
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("batteries",
                               Some (OASISVersion.VGreaterEqual "2"));
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_ccss.ml"});
               Test
                 ({
                     cs_name = "test_ccss";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_working_directory = Some "tests/testsets";
                      test_run =
                        [
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "AR\237g\031\250\0280\022\003\219O(\242\166\"";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
